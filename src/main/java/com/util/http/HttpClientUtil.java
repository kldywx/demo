...
import com.util.http.constants.HttpConstants;
import com.util.http.handler.HttpRequestRetryHandler;
import com.util.http.model.HttpOptions;
import com.util.http.model.HttpRequest;
import com.util.http.model.HttpResponse;
import com.util.http.constants.HttpConstants;
import com.util.http.handler.HttpRequestRetryHandler;
...
public class HttpClientUtil {
    ...
    private static PoolingHttpClientConnectionManager buildPoolingHttpClientConnectionManager(Integer maxTotal, Integer maxPerRoute) {
        ...
        if (Objects.nonNull(maxTotal)) { //首先看有没有在参数中显式指定
            ...
            maxTotalProperty = System.getProperty(HttpConstants.SYSTEM_PROPERTY_KEY_HTTP_MAX_TOTAL);
        ...
        if (Objects.nonNull(maxPerRoute)) { //首先看有没有在参数中显式指定
            ...
            maxPerRouteProperty = System.getProperty(HttpConstants.SYSTEM_PROPERTY_KEY_HTTP_MAX_PER_ROUTE);
